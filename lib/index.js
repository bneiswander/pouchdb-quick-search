...
import NoDDocs from 'pouchdb-mapreduce-no-ddocs';
export const _search_query = NoDDocs._search_query
export const _search_viewCleanup = NoDDocs._search_viewCleanup
...
export const search = utils.toPromise(function (opts, callback) {
  ...
  pouch._search_query(mapFun, {
    ...
    // step 2
    return pouch._search_query(mapFun, queryOpts2).then(function (res) {
